const CACHE_VERSION = 'pedroza-portal-v1.12.1';
...
const CORE = [
  ...
  `${ROOT}pages/legislacao/`,
  `${ROOT}assets/css/legislation.css`,
  `${ROOT}assets/js/legislation.js`,
  ...
  `${ROOT}data/agenda-tributaria.json`,
  `${ROOT}data/caa-consolidado.json`,
  `${ROOT}data/caa-status.json`
];
