export const CAA_VERSION = '1.14.0';
...
export const OFFICIAL_HOSTS = [
  ...
  'caixa.gov.br', 'fgts.gov.br', 'sistema.gov.br', 'sped.rfb.gov.br', 'cjf.jus.br', 'trt1.jus.br', 'crc.org.br', 'tse.jus.br', 'trf2.jus.br', 'tjrj.jus.br', 'carf.economia.gov.br'
];
